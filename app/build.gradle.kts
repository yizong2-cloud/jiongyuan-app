...
val packageName = if (release) "com.jiongyuan.app" else "com.jiongyuan.app.debug"
val labelNameRes = if (release) "@string/app_name" else "囧源 Debug"
...
//    }
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = System.getenv("STORE_PASSWORD") ?: "jiongyuan2026"
            keyAlias = System.getenv("KEY_ALIAS") ?: "jiongyuan"
            keyPassword = System.getenv("KEY_PASSWORD") ?: "jiongyuan2026"
        }
    }
